...
const debug = Debug('NOWnews-admin-website: controllers:dailyplan:action.update');
...
module.exports = async (req, res, next) => {
    ...
    try {
        ...
        startedAt = moment.tz(startedAt,'YYYY-MM-DDTHH:mm:ss','Asia/Taipei').format('YYYY-MM-DDTHH:mm:ss');
